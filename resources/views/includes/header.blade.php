                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        <a href="{{ route('index') }}" class="m-brand__logo-wrapper">
                            <img alt="" src="{{ asset('uploads/footer_logos/'.$settings->footer_logo)  }}" style="width: 170px;">
                        </a>
                    </div>
                    <div class="m-stack__item m-stack__item--middle m-brand__tools">
                        ...
                        <a id="m_aside_header_menu_mobile_toggle" href="javascript:void(0)" style="display: none !important;"
                                ...
                                @if(Auth()->user())
                                    <a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
                                                        ...
                                                        <img
                                                            src="{{asset("/uploads/user_profiles/".Auth()->user()->profile_pic)}}"
                                        ...
                                        <span class="m-topbar__username m--hide">etst</span>
                                    </a>
                                            ...
                                            <div class="m-dropdown__header m--align-center"
                                                ...
                                                <div class="m-card-user m-card-user--skin-dark">
                                                    ...
                                                    <div class="m-card-user__details">
                                                        <span
                                                            class="m-card-user__name m--font-weight-500">{{ Auth()->user()->fullName() }}</span>
                                                        <a href=""
