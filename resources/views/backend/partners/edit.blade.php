    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                <div class="col-lg-12">
                    <div class="m-portlet">
                        <form class="m-form" method="post" action="{{ route('admin.partners.update',$user->id) }}"
                              id="create"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            <label for="description"
                                                   class="col-md-6 col-form-label text-md-left">{{ __('Description') }}
                                               </label>
                                            <textarea id="description" type="text"
                                                      class="form-control @error('description') is-invalid @enderror"
                                                      name="description"
                                                      autocomplete="last_name"
                                                      autofocus>{{ old('description',$user->description) }}</textarea>
                                        ...
                                        <div class="col-md-6">
                                            <label for="image"
                                                   class="col-md-4 col-form-label text-md-left">{{ __('Logo') }} <span
                                                    class="mandatorySign">*</span></label>
                                            <input value="{{old('logo',$user->logo)}}" type="file"
                                                   class="form-control @error('logo') is-invalid @enderror"
                                                   onchange="readURLLogo(this)" id="logo"
                                                   name="logo" style="padding: 9px; cursor: pointer">
                                            <img width="300" height="200" class="img-thumbnail" style="display:{{($user->logo) ? 'block' : 'none'}}"
                                                 id="imglogo"  src="{{ asset('/uploads/partners_logos/'.$user->logo) }}"
                                                 alt="{{$user->logo}}"/>
