    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                <div class="col-lg-12">
                    <div class="m-portlet">
                        <form class="m-form" method="post" action="{{ route('admin.offers.update',$offer->id) }}"
                              id="create"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form__section m-form__section--first">
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <select id="partner_id"
                                                ...
                                                @if(!empty($partners) && count($partners) > 0)
                                                    @foreach($partners as $partner)
                                                        <option
                                                            value="{{$partner->id}}" {{ old('partner_id',$offer->partner_id) == $partner->id ? 'selected' : ''}}>{{ $partner->fullname() }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="status"
                                                ...
                                                <option
                                                    value="active" {{ (old('status',$offer->status) == 'active') ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option
                                                    value="inactive" {{ (old('status',$offer->status) == 'inactive') ? 'selected' : '' }}>
                                                    Inactive
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input id="system_wattage" type="text"
                                                   ...
                                                   name="system_wattage"
                                                   value="{{ old('system_wattage',$offer->system_wattage) }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="net_metering"
                                                ...
                                                <option
                                                    value="yes" {{ (old('net_metering',$offer->net_metering) == 'yes') ? 'selected' : '' }}>
                                                    Yes
                                                <option
                                                    value="no" {{ (old('net_metering',$offer->net_metering) == 'no') ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                            @error('net_metering')
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <select id="battery_system"
                                                ...
                                                <option
                                                    value="yes" {{ (old('battery_system',$offer->battery_system) == 'yes') ? 'selected' : '' }}>
                                                    Yes
                                                <option
                                                    value="no" {{ (old('battery_system',$offer->battery_system) == 'no') ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="panel_model" type="text"
                                                   ...
                                                   name="panel_model"
                                                   value="{{ old('panel_model',$offer->panel_model) }}"
                                                   autocomplete="panel_model">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <select id="panel_type"
                                                ...
                                                <option
                                                    value="Monocrystalline" {{ (old('panel_type',$offer->panel_type) == 'Monocrystalline') ? 'selected' : '' }}>
                                                    Monocrystalline
                                                <option
                                                    value="Polycrystalline" {{ (old('panel_type',$offer->panel_type) == 'Polycrystalline') ? 'selected' : '' }}>Polycrystalline
                                                </option>
                                                <option
                                                    value="Thinfilm" {{ (old('panel_type',$offer->panel_type) == 'Thinfilm') ? 'selected' : '' }}>Thin-film
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="inverter_brand" type="text"
                                                   ...
                                                   name="inverter_brand"
                                                   value="{{ old('inverter_brand',$offer->inverter_brand) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <select id="battery_bank_type"
                                                ...
                                                <option
                                                    value="Lead-acid" {{ (old('battery_bank_type',$offer->battery_bank_type) == 'Lead-acid') ? 'selected' : '' }}>
                                                    Lead acid
                                                </option>
                                                <option
                                                    value="Lithium-ion" {{ (old('battery_bank_type',$offer->battery_bank_type) == 'Lithium-ion') ? 'selected' : '' }}>Lithium ion
                                                </option>
                                                <option
                                                    value="Nickel-Cadmium" {{ (old('battery_bank_type',$offer->battery_bank_type) == 'Nickel-Cadmium') ? 'selected' : '' }}>Nickel Cadmium
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="batter_storage_capacity" type="text"
                                                   ...
                                                   value="{{ old('batter_storage_capacity',$offer->batter_storage_capacity) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <select id="smart_monitoring_application"
                                                ...
                                                <option
                                                    value="yes" {{ (old('smart_monitoring_application',$offer->smart_monitoring_application) == 'yes') ? 'selected' : '' }}>
                                                    Yes
                                                <option
                                                    value="no" {{ (old('smart_monitoring_application',$offer->smart_monitoring_application) == 'no') ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="customer_support" type="text"
                                                   class="form-control @error('customer_support',$offer->customer_support) is-invalid @enderror"
                                                   name="customer_support"
                                                   value="{{ old('customer_support',$offer->customer_support) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input id="warranty_of_panel" type="text"
                                                   ...
                                                   value="{{ old('warranty_of_panel',$offer->warranty_of_panel) }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="warranty_of_batteries" type="text"
                                                   ...
                                                   value="{{ old('warranty_of_batteries',$offer->warranty_of_batteries) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input id="warranty_of_inverter" type="text"
                                                   ...
                                                   value="{{ old('warranty_of_inverter',$offer->warranty_of_inverter) }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="payback_period_in_years" type="text"
                                                   ...
                                                   value="{{ old('payback_period_in_years',$offer->payback_period_in_years) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input id="payback_period_in_months" type="text"
                                                   ...
                                                   value="{{ old('payback_period_in_months',$offer->payback_period_in_months) }}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="savings_for_ten_years" type="text"
                                                   ...
                                                   value="{{ old('savings_for_ten_years',$offer->savings_for_ten_years) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <select id="financing_options"
                                                ...
                                                <option
                                                    value="yes" {{ (old('financing_options',$offer->financing_options) == 'yes') ? 'selected' : '' }}>
                                                    Yes
                                                <option
                                                    value="no" {{ (old('financing_options',$offer->financing_options) == 'no') ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input id="total_price_of_offering" type="text"
                                                   ...
                                                   value="{{ old('total_price_of_offering',$offer->total_price_of_offering) }}"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <select id="city"
                                                ...
                                                <option
                                                    value="lahore" {{ (old('city',$offer->city) == 'lahore') ? 'selected' : '' }}>
                                                    Lahore
                                                <option
                                                    value="karachi" {{ (old('city',$offer->city) == 'karachi') ? 'selected' : '' }}>
                                                    Karachi
                                                </option>
                                            </select>
                                            @error('city')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="region"
                                                ...
                                                <option
                                                    value="punjab" {{ (old('region',$offer->region) == 'punjab') ? 'selected' : '' }}>
                                                    Punjab
                                                <option
                                                    value="sindh" {{ (old('region',$offer->region) == 'sindh') ? 'selected' : '' }}>
                                                    Sindh
                                                </option>
                                            </select>
                                            @error('region')
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label for="image"
                                                   class="col-md-4 col-form-label text-md-left">{{ __('Proposal File') }}
                                                <span
                                                    class="mandatorySign">*</span></label>
                                            <input value="{{old('proposal_file',$offer->proposal_file)}}" type="file"
                                                   class="form-control @error('proposal_file') is-invalid @enderror"
                                                   id="image"
                                                   name="proposal_file" style="padding: 9px; cursor: pointer">

                                            <a href="{{ asset('/uploads/pdfFiles/'.$offer->id.'/'.$offer->proposal_file) }}"
                                               target="_blank">{{$offer->proposal_file}}</a>
