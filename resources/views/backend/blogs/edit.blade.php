    ...
    <div class="m-content">
        <div class="m-portlet m-portlet--mobile">
            ...
            <div class="m-portlet__body">
                <div class="col-lg-12">
                    <div class="m-portlet">
                        <form class="m-form" method="post" action="{{ route('admin.blogs.update',$blog->id) }}"
                              id="create"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="summary"
                                                      ...
                                                      autocomplete="summary">{{ old('summary',$blog->summary) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="description"
                                                      ...
                                                      name="description" style="height: 200px !important;"
                                                      autocomplete="description">{{ old('description',$blog->description) }}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            <label for="image"
                                                ...
                                                <abbr
                                                    title="Ratio is 16 means Width and 9 means Height">?</abbr> <span
                                                    class="mandatorySign">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="status"
                                                ...
                                                <option
                                                    value="active" {{ (old('status',$blog->status) == 'active') ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option
                                                    value="inactive" {{ (old('status',$blog->status) == 'inactive') ? 'selected' : '' }}>
                                                    Inactive
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <select id="is_featured"
                                                ...
                                                <option
                                                    value="yes" {{ (old('is_featured',$blog->is_featured) == 'yes') ? 'selected' : '' }}>
                                                    Yes
                                                </option>
                                                <option
                                                    value="no" {{ (old('is_featured',$blog->is_featured) == 'no') ? 'selected' : '' }}>
                                                    No
                                                </option>
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="is_order"
                                                ...
                                                <option
                                                    value="0" {{ (old('is_order',$blog->is_order) == '0') ? 'selected' : '' }}>
                                                    0
                                                </option>
                                                <option
                                                    value="1" {{ (old('is_order',$blog->is_order) == '1') ? 'selected' : '' }}>
                                                    1
                                                </option>
                                                <option
                                                    value="2" {{ (old('is_order',$blog->is_order) == '2') ? 'selected' : '' }}>
                                                    2
                                                </option>
                                                <option
                                                    value="3" {{ (old('is_order',$blog->is_order) == '3') ? 'selected' : '' }}>
                                                    3
                                                </option>
                                            </select>
